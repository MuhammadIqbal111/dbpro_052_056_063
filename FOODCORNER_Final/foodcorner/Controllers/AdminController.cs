...
namespace foodcorner.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult AdminAddcart(int? id)
        {
            ...
            db.SaveChanges();
            return RedirectToAction("ViewSupplierItems", new { id = cat.CatId });

        }

        public ActionResult ViewAdminCart()
        {
            orderid = Convert.ToInt32(TempData["pp"]);
        ...
        public ActionResult DeleteConfirmed222(int id)
        {
            ...
            db.SaveChanges();
            return RedirectToAction("ViewAdminCart", "Admin");
        }
